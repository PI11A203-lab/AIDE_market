...
import { showcaseDemosKo, showcaseDemosEn, showcaseDemosJa } from './routes/product/data/productShowcaseDemos';
  ...
  ko: {
    translation: {
      ...
      chatbot: {
        ...
        closeAria: '닫기',
        greeting: '안녕하세요 👋',
        greetingSub: '무엇이 궁금하신가요?',
        help: '도움말',
        recentMessages: '최근 메시지',
        startConversation: '대화를 시작해 보세요',
        agentMeta: 'AIDE Market 도우미 • 지금',
        statusOk: '모든 시스템 정상 작동 중',
        statusMeta: 'AIDE Market 도우미 준비됨',
        searchPlaceholder: '검색...',
        helpSearchTitle: '도움말 검색',
        searchDefaultQuery: '도움말 보여줘',
        helpIntro: '이용 전 꼭 알아두세요!',
        getSupport: '지원을 받는 방법',
        aideIntro: 'AIDE Market 소개',
        studentDiscount: '학생 할인 받는 법',
        faq: '자주 묻는 질문',
        backToList: '목록',
        welcomeTitle: '대화를 시작해 보세요.',
        welcomeSub: '궁금한 걸 입력하거나 홈에서 버튼을 눌러 주세요.',
        goToTemplates: '템플릿 페이지로 이동하기',
        inputPlaceholder: '메시지를 입력하세요...',
        send: '전송',
        thinking: '답변을 생각하고 있어요...',
        home: '홈',
        messages: '메시지',
        queryGetSupport: '지원을 받는 방법',
        queryAideIntro: 'AIDE Market이 뭐예요?',
        queryStudentDiscount: '학생 할인 받는 법 알려줘',
        queryFaq: '자주 묻는 질문 알려줘',
      },
      notifications: {
        team: {
      ...
      profile: {
        ...
        reviews: {
          ...
          ratingLabel: '별점',
          reviewTitleLabel: '리뷰 제목',
          reviewTitlePlaceholder: '제목을 입력하세요',
          ...
          reviewImagesLabel: '리뷰 이미지',
          addImage: '이미지 추가',
          removeImage: '삭제',
          imageOnly: '이미지 파일만 업로드 가능합니다.',
          imageSize: '이미지 크기는 5MB 이하여야 합니다.',
          reviewImagesHint: '최대 {{max}}장까지 추가할 수 있습니다. 클릭하여 제거할 수 있습니다.',
          edit: '수정',
          delete: '삭제',
        ...
        superAdmin: {
          ...
          products: {
            ...
            mock: {
              ...
              categoryDesign: '디자인',
              product1: {
                name: 'AI 코드 리뷰어 - 자동 품질 검사',
                description: '코드 품질을 자동으로 검사하고 개선 사항을 제안하는 AI 도구입니다. 다양한 언어를 지원합니다.',
              },
              product2: {
                name: '자동 레포트 작성 AI',
                description: '주제만 입력하면 자동으로 레포트를 작성해주는 AI 서비스입니다.',
              },
              product3: {
                name: '이미지 배경 제거 AI',
                description: '이미지에서 배경을 자동으로 제거하고 투명 PNG로 저장합니다.',
              },
            },
          },
      ...
      useCaseGuide: {
        title: '뭘 만들고 싶으세요?',
        subtitle: '목적에 맞는 템플릿을 골라 시작해보세요',
        web: { label: '웹사이트 만들기', desc: '회사 홈페이지, 블로그 등' },
        shop: { label: '쇼핑몰 / 전자상거래', desc: '온라인 스토어 운영' },
        app: { label: '앱 만들기', desc: '모바일·Android 앱' },
        doc: { label: '문서·업무 자동화', desc: '보고서, 정리, 요약 등' },
        custom: { label: '직접 구성', desc: '찜한 AI 중에서 골라서 팀 만들기' },
      },
      teamBuilder: {
        pageTitle: 'AI 팀 구성',
        pageSubtitle: '목적에 맞게 AI를 조합해 최강의 팀을 만들어보세요',
        typing1: '웹 개발 팀을 구성해보세요',
        typing2: '쇼핑몰 프로젝트 팀을 만들어보세요',
        typing3: '맞춤형 AI 팀을 구성해보세요',
        ...
        teamTotal: '팀 합계',
        keyStrengthsTitle: '주요 강점',
        recommendedProjectsTitle: '추천 프로젝트',
...
실제 서비스 출시까지 시간을 크게 단축할 수 있었습니다." - 프로젝트 리더`,
      ...
      product: {
        ...
        showcase: {
          ...
          useCasesHeading: '이렇게 쓸 수 있어요',
          demoPlaceholder: '3D 모델 생성 데모는 준비 중입니다. 곧 체험하실 수 있습니다.',
          demoHint: '예시를 선택하면 입력/결과가 바뀝니다.',
          demoInputLabel: '입력 예시',
          demoOutputLabel: '결과',
          demoImagePlaceholder: '데모 이미지를 추가하려면 config의 demoImageUrl을 설정하세요',
          modelia: {
            heroTitle: '고품질 3D 모델을 생성합니다',
            heroSubtitle: '게임·영상 제작에 바로 쓸 수 있는 3D 아셋을 만들어 드립니다.',
            useCase1Title: '게임 에셋',
            useCase1Desc: '캐릭터, 오브젝트, 환경 3D 모델',
            useCase2Title: '영상·VFX',
            useCase2Desc: '영상용 3D 소스 및 연출 자산',
            useCase3Title: '프로토타입',
            useCase3Desc: 'UI/공간 시각화용 빠른 모델',
            useCase4Title: '다양한 포맷',
            useCase4Desc: 'FBX, OBJ, glTF 등 내보내기',
            demoCta: '데모 체험하기',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '인디 게임 캐릭터 팩',
            project1Desc: '2D 컨셉에서 3D 캐릭터 10종 생성, 리깅·애니 호환',
            project1Meta: '약 2주 · Modelia 단독',
            project2Title: '쇼트 영상 VFX 소스',
            project2Desc: '폭발·환경 3D 소스 20종, 컴포지팅용',
            project2Meta: '약 1주 · Modelia + 편집 툴',
            project3Title: 'VR 전시관 프로토타입',
            project3Desc: '전시 공간·전시물 3D 모델, 실시간 뷰어 연동',
            project3Meta: '약 3주 · Modelia + Unity',
            demoTitle: 'Modelia 데모',
            demoInputLabel: '입력 예시',
            demoOutputLabel: '결과',
            demoExample1Label: '캐릭터 생성',
            demoExample1Code: "modelia.generate({ type: 'character', style: 'lowpoly' })",
            demoExample1Result: 'character_lp_01.fbx (1.2MB)',
            demoExample2Label: '오브젝트 생성',
            demoExample2Code: "modelia.generate({ type: 'object', prompt: 'medieval chest' })",
            demoExample2Result: 'object_chest_01.glb (0.8MB)',
            demoExample3Label: '환경 생성',
            demoExample3Code: "modelia.generate({ type: 'environment', resolution: '2k' })",
            demoExample3Result: 'env_forest_01.fbx (3.1MB)',
          },
          tech: {
            javascript: 'JavaScript', typescript: 'TypeScript', react: 'React', vue: 'Vue.js', next: 'Next.js', angular: 'Angular', svelte: 'Svelte', jquery: 'jQuery', webcomponents: 'Web Components', nuxt: 'Nuxt.js', remix: 'Remix', solid: 'SolidJS',
            node: 'Node.js', django: 'Django', spring: 'Spring Boot', go: 'Go', rust: 'Rust', laravel: 'Laravel', rails: 'Ruby on Rails', dotnet: '.NET', kotlin: 'Kotlin', scala: 'Scala', nest: 'NestJS', fastapi: 'FastAPI',
            illustration: '일러스트', pixel: '도트/픽셀아트', landscape: '풍경', animation: '애니메이션', logo: '로고·브랜딩', character: '캐릭터', uiux: 'UI/UX', icon: '아이콘', texture: '텍스처', midjourney: 'AI 이미지', dalle: 'AI 이미지',
            planning: '기획', task: '태스크 관리', merge: '통합', req: '요건 정의', arch: '아키텍처', quality: '품질', agile: '애자일', scrum: '스크럼', po: 'PO', techlead: '테크 리드',
            docker: 'Docker', cloudflare: 'Cloudflare', fly: 'Fly.io', aws: 'AWS', gcp: 'GCP', k8s: 'Kubernetes', azure: 'Azure', terraform: 'Terraform', cicd: 'CI/CD', monitor: '모니터링', devops: 'DevOps', data: '데이터', vercel: 'Vercel', netlify: 'Netlify',
            audit: '코드 감사', access: '접근 제어', crypto: '암호화', vuln: '취약점 스캔', log: '로그 분석', network: '네트워크 보안', pentest: '침투 테스트', firewall: '방화벽', ids: 'IDS/IPS', compliance: '컴플라이언스', zerotrust: '제로 트러스트', threat: '위협 탐지',
            excel: 'Excel', ppt: 'PowerPoint', github_doc: 'GitHub 문서', word: 'Word', notion: 'Notion', mail: '메일', confluence: 'Confluence', markdown: 'Markdown', api_doc: 'API 문서', tech_writer: '기술 문서', figma_doc: 'Figma 문서', swagger: 'Swagger',
          },
          frontend: {
            heroTitle: '{{productName}}: {{tech}}로 모던한 UI를 구축합니다',
            heroSubtitle: '컴포넌트·상태 관리·라우팅까지, 프론트엔드 개발을 가속합니다.',
            useCase1Title: 'SPA·SSR',
            useCase1Desc: '싱글 페이지 앱·서버 렌더링',
            useCase2Title: '상태 관리',
            useCase2Desc: '전역/로컬 상태·폼 처리',
            useCase3Title: '반응형 UI',
            useCase3Desc: '다양한 화면 크기 대응',
            useCase4Title: '접근성·SEO',
            useCase4Desc: '시맨틱·메타·성능 최적화',
            demoCta: '예시 코드 보기',
            demoExampleCode: "const App = () => {\n  const [count, setCount] = useState(0);\n  return (\n    <div>\n      <button onClick={() => setCount(c => c + 1)}>{count}</button>\n    </div>\n  );\n};",
            demoExampleResult: '✓ 컴포넌트 렌더 완료\n✓ 클릭 시 count 증가\n✓ React 18 호환',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '대시보드·관리 화면',
            project1Desc: '테이블·차트·필터가 있는 관리자 UI',
            project1Meta: '약 2주 · {{productName}} 단독',
            project2Title: '랜딩·마케팅 페이지',
            project2Desc: 'SEO·반응형 랜딩 페이지',
            project2Meta: '약 1주 · {{productName}} + 백엔드',
            project3Title: '이커머스·결제 플로우',
            project3Desc: '장바구니·결제·주문 조회 UI',
            project3Meta: '약 3주 · {{productName}} + API',
          },
          backend: {
            heroTitle: '{{productName}}: {{tech}}로 API·서버를 구축합니다',
            heroSubtitle: 'REST·인증·DB 연동까지, 백엔드 개발을 가속합니다.',
            useCase1Title: 'REST API',
            useCase1Desc: '엔드포인트·검증·에러 처리',
            useCase2Title: 'DB·ORM',
            useCase2Desc: '모델·마이그레이션·쿼리',
            useCase3Title: '인증·권한',
            useCase3Desc: 'JWT·세션·역할 기반 접근',
            useCase4Title: '실시간·배치',
            useCase4Desc: 'WebSocket·큐·스케줄',
            demoCta: '예시 코드 보기',
            demoExampleCode: "app.get('/api/users', (req, res) => {\n  const users = await db.query('SELECT * FROM users');\n  res.json(users);\n});",
            demoExampleResult: '✓ GET /api/users 200\n✓ [{ "id": 1, "name": "..." }]',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '회원·결제 API',
            project1Desc: '가입·로그인·결제 연동 API',
            project1Meta: '약 2주 · {{productName}} 단독',
            project2Title: '관리자 백오피스',
            project2Desc: 'CRUD·대시보드·리포트 API',
            project2Meta: '약 3주 · {{productName}} + 프론트',
            project3Title: '마이크로서비스',
            project3Desc: '서비스 분리·이벤트·메시징',
            project3Meta: '약 4주 · {{productName}} + 인프라',
          },
          image: {
            heroTitle: '{{productName}}: {{tech}}를 생성합니다',
            heroSubtitle: '프롬프트·스타일에 맞춘 고품질 결과물을 제공합니다.',
            useCase1Title: '스타일·퀄리티',
            useCase1Desc: '다양한 스타일·해상도 지원',
            useCase2Title: '배치·일괄',
            useCase2Desc: '여러 장 생성·일관된 톤',
            useCase3Title: '수정·리터치',
            useCase3Desc: '요청에 따른 수정·보정',
            useCase4Title: '포맷·연동',
            useCase4Desc: '다양한 포맷·다운로드',
            demoCta: '예시 결과 보기',
            demoExamplePrompt: 'prompt: "일러스트, 풍경, 로고 등"\nstyle: "minimal"',
            demoImageLabel: '생성 결과',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '앱·웹 에셋',
            project1Desc: 'UI용 이미지·아이콘·일러스트',
            project1Meta: '약 1주 · {{productName}}',
            project2Title: '마케팅·광고',
            project2Desc: '배너·소셜·프레젠테이션용',
            project2Meta: '약 1주 · {{productName}}',
            project3Title: '게임·영상',
            project3Desc: '캐릭터·배경·VFX 소스',
            project3Meta: '약 2주 · {{productName}} + 툴',
          },
          management: {
            heroTitle: '{{productName}}: {{tech}}로 프로젝트를 이끕니다',
            heroSubtitle: '기획·일정·품질까지, 팀 생산성을 높입니다.',
            useCase1Title: '일정·태스크',
            useCase1Desc: 'WBS·마일스톤·담당 배정',
            useCase2Title: '문서·정의',
            useCase2Desc: '요구사항·스펙·회의록',
            useCase3Title: '품질·리뷰',
            useCase3Desc: '코드 리뷰·테스트·배포',
            useCase4Title: '협업·커뮤니케이션',
            useCase4Desc: '알림·이슈·회고',
            demoCta: '예시 보기',
            demoExampleCode: "- [ ] 태스크 A\n- [ ] 태스크 B\n마일스톤: 2025-02-15",
            demoExampleResult: '✓ WBS 생성 완료\n✓ 담당자 배정 제안\n✓ 일정 차트 반영',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '스프린트 운영',
            project1Desc: '스프린트 계획·일일 스탠드업·회고',
            project1Meta: '지속 · {{productName}}',
            project2Title: '요건·스펙 정리',
            project2Desc: 'PRD·기능 명세·API 스펙',
            project2Meta: '약 2주 · {{productName}}',
            project3Title: '아키텍처·리팩터링',
            project3Desc: '시스템 설계·기술 선택·개선',
            project3Meta: '약 3주 · {{productName}}',
          },
          infrastructure: {
            heroTitle: '{{productName}}: {{tech}}로 인프라를 구축합니다',
            heroSubtitle: '배포·모니터링·자동화까지, 안정적인 서비스를 만듭니다.',
            useCase1Title: '빌드·배포',
            useCase1Desc: 'CI/CD·컨테이너·스테이징',
            useCase2Title: '리소스·네트워크',
            useCase2Desc: '서버·스토리지·CDN',
            useCase3Title: '모니터링·알람',
            useCase3Desc: '로그·메트릭·장애 대응',
            useCase4Title: '보안·비용',
            useCase4Desc: '접근 제어·비용 최적화',
            demoCta: '예시 설정 보기',
            demoExampleCode: "docker run -d -p 8080:80 \\\n  --name app my-registry/app:latest",
            demoExampleResult: '✓ 컨테이너 시작\n✓ 8080 → 80 매핑\n✓ 헬스체크 통과',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '컨테이너 배포',
            project1Desc: 'Docker·K8s·헬스체크',
            project1Meta: '약 1주 · {{productName}}',
            project2Title: '멀티 리전 서비스',
            project2Desc: '글로벌 CDN·DB·백업',
            project2Meta: '약 2주 · {{productName}}',
            project3Title: 'IaC·자동화',
            project3Desc: 'Terraform·파이프라인·이벤트',
            project3Meta: '약 3주 · {{productName}}',
          },
          security: {
            heroTitle: '{{productName}}: {{tech}}로 보안을 강화합니다',
            heroSubtitle: '감사·암호화·침입 탐지까지, 안전한 시스템을 지킵니다.',
            useCase1Title: '정책·접근 제어',
            useCase1Desc: '권한·인증·세션',
            useCase2Title: '암호화·키 관리',
            useCase2Desc: '데이터·통신 암호화',
            useCase3Title: '스캔·대응',
            useCase3Desc: '취약점·침입 탐지·대응',
            useCase4Title: '컴플라이언스',
            useCase4Desc: '정책·감사·리포트',
            demoCta: '예시 보기',
            demoExampleCode: "audit.run({ target: 'src/', rules: 'owasp' })",
            demoExampleResult: '✓ 12 파일 스캔\n✓ 취약 0건, 경고 2건\n✓ 리포트 생성 완료',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '보안 감사·리포트',
            project1Desc: '코드·설정 감사·권고 사항',
            project1Meta: '약 1주 · {{productName}}',
            project2Title: '인증·권한 체계',
            project2Desc: 'SSO·RBAC·이벤트 로그',
            project2Meta: '약 2주 · {{productName}}',
            project3Title: '위협 대응 파이프라인',
            project3Desc: '탐지·분류·대응·리포트',
            project3Meta: '약 3주 · {{productName}}',
          },
          documents: {
            heroTitle: '{{productName}}: {{tech}} 문서 작업을 도와줍니다',
            heroSubtitle: '작성·정리·자동화까지, 문서 업무를 가속합니다.',
            useCase1Title: '초안·요약',
            useCase1Desc: '자동 작성·번역·요약',
            useCase2Title: '템플릿·형식',
            useCase2Desc: '보고서·스펙·슬라이드',
            useCase3Title: '협업·버전',
            useCase3Desc: '공유·리뷰·버전 관리',
            useCase4Title: '검색·연동',
            useCase4Desc: '검색·API·다른 도구 연동',
            demoCta: '예시 보기',
            demoExampleCode: "doc.generate({ type: 'readme', repo: 'my-app' })",
            demoExampleResult: '✓ README.md 생성\n✓ 설치·사용법·API 요약\n✓ Changelog 반영',
            showcaseTitle: '이걸로 만든 것처럼',
            project1Title: '기술 문서·API 문서',
            project1Desc: 'README·스펙·Changelog',
            project1Meta: '약 1주 · {{productName}}',
            project2Title: '보고서·제안서',
            project2Desc: '주간 보고·제안서·회의록',
            project2Meta: '약 1주 · {{productName}}',
            project3Title: '지식 베이스',
            project3Desc: 'Confluence·Notion·FAQ',
            project3Meta: '약 2주 · {{productName}}',
          },
        },
        demos: showcaseDemosKo,
        trust: {
          title: '검증 및 신뢰',
          identity: '신원 인증 완료',
          topRated: '최고 평점 개발자',
      ...
      creators: {
        ...
        noProductsHint: '곧 새로운 AI 상품을 선보일 예정입니다.',
        downloads: '다운로드',
        totalDownloads: '총 다운로드',
        avgRating: '평균 평점',
        totalReviews: '총 리뷰',
        categoryDistribution: '카테고리별 상품 분포',
        productsCount: '상품 수',
        followers: '팔로워',
        followError: '팔로우 처리 중 오류가 발생했습니다.',
        followHint: '팔로우하면 새 AI 출시·이벤트 소식을 받을 수 있어요',
        followHintDetail: '팔로우 시 새 AI 출시 소식과 특별 이벤트를 가장 먼저 받아보세요',
        whyFollowTitle: '팔로우하면 좋은 점',
        whyFollow1: '새 AI 출시 시 알림을 받을 수 있어요',
        whyFollow2: '특별 할인·이벤트 정보를 받아보세요',
        whyFollow3: '마이페이지에서 관심 크리에이터를 한눈에',
        whyFollow4: '인기 많은 개발자의 최신 AI를 놓치지 마세요',
      },
      sellerInfo: {
        pageTitle: '판매자 안내',
  ...
  en: {
    translation: {
      ...
      chatbot: {
        ...
        closeAria: 'Close',
        greeting: 'Hello 👋',
        greetingSub: 'How can we help you?',
        help: 'Help',
        recentMessages: 'Recent messages',
        startConversation: 'Start a conversation',
        agentMeta: 'AIDE Market assistant • Now',
        statusOk: 'Status: All Systems Operational',
        statusMeta: 'AIDE Market assistant ready',
        searchPlaceholder: 'Search...',
        helpSearchTitle: 'Help search',
        searchDefaultQuery: 'Show help',
        helpIntro: 'Please read before using!',
        getSupport: 'How to get support',
        aideIntro: 'About AIDE Market',
        studentDiscount: 'Student discount',
        faq: 'FAQ',
        backToList: 'List',
        welcomeTitle: 'Start the conversation.',
        welcomeSub: 'Type your question or tap a button on Home.',
        ...
        home: 'Home',
        messages: 'Messages',
        queryGetSupport: 'How to get support',
        queryAideIntro: 'What is AIDE Market?',
        queryStudentDiscount: 'Tell me about student discount',
        queryFaq: 'Show me FAQ',
      },
      notifications: {
        team: {
...
"Using AI developers allowed us to quickly create prototypes and significantly reduce time to service launch." - Project Leader`,
      ...
      creators: {
        ...
        followHint: 'Get notified when they release new AI & special events',
        followHintDetail: 'Be the first to know about new AI releases and exclusive events',
        whyFollowTitle: 'Why Follow Creators?',
        whyFollow1: 'Get notified when they release new AI',
        whyFollow2: 'Receive special discount and event updates',
        whyFollow3: 'See all your favorite creators in one place',
        whyFollow4: 'Never miss the latest from top developers',
      },
      sellerInfo: {
      ...
      profile: {
        ...
        reviews: {
          ...
          reviewTitlePlaceholder: 'Enter title...',
          ...
          reviewImagesLabel: 'Review Images',
          addImage: 'Add Image',
          removeImage: 'Remove',
          imageOnly: 'Only image files can be uploaded.',
          imageSize: 'Image size must be 5MB or less.',
          reviewImagesHint: 'Up to {{max}} images. Click X to remove.',
          edit: 'Edit',
          delete: 'Delete',
        ...
        superAdmin: {
          ...
          dashboard: {
            ...
            studentRequest: 'Student Verification Request',
            pending: 'Pending',
            today: 'Today',
            percent: '+0%',
            sections: {
          ...
          products: {
            ...
            mock: {
              categoryDev: 'Development Tools',
              categoryStudy: 'Learning Tools',
              categoryDesign: 'Design',
              product1: {
                name: 'AI Code Reviewer - Auto Quality Check',
                description: 'AI tool that automatically checks code quality and suggests improvements. Supports multiple languages.',
              },
              product2: {
                name: 'Auto Report Writer AI',
                description: 'AI service that automatically generates reports from just a topic input.',
              },
              product3: {
                name: 'Image Background Remover AI',
                description: 'Automatically removes backgrounds from images and saves as transparent PNG.',
              },
            },
          },
          studentVerifications: {
      ...
      useCaseGuide: {
        ...
        subtitle: 'Pick a template that matches your goal and get started',
        web: { label: 'Website', desc: 'Company site, blog, etc.' },
        shop: { label: 'Online Store / E-commerce', desc: 'Run an online shop' },
        app: { label: 'App Development', desc: 'Mobile, Android apps' },
        doc: { label: 'Documents & Automation', desc: 'Reports, summaries, organization' },
        custom: { label: 'Build Your Own', desc: 'Choose from your favorites' },
      },
      teamBuilder: {
        pageTitle: 'AI Team Builder',
        pageSubtitle: 'Combine AIs for your purpose and build the strongest team',
        typing1: 'Build a web development team',
        typing2: 'Create an e-commerce project team',
        typing3: 'Compose your custom AI team',
        ...
        recommendedProjectsTitle: 'Recommended Projects',
      ...
      teamBenefits: {
        ...
        team: 'Team',
        individualDesc: 'Each AI alone',
        teamDesc: 'Combined as team',
        synergyGain: 'Synergy',
      ...
      product: {
        ...
        showcase: {
          ...
          useCasesHeading: 'What you can use it for',
          demoPlaceholder: '3D model generation demo is coming soon.',
          demoHint: 'Select an example to see input and result.',
          demoInputLabel: 'Example input',
          demoOutputLabel: 'Result',
          demoImagePlaceholder: 'Set demoImageUrl in config to show a demo image',
          modelia: {
            heroTitle: 'Generates high-quality 3D models',
            heroSubtitle: 'Creates 3D assets ready for games and video production.',
            useCase1Title: 'Game assets',
            useCase1Desc: 'Characters, objects, environment 3D models',
            useCase2Title: 'Video & VFX',
            useCase2Desc: '3D sources and assets for film & VFX',
            useCase3Title: 'Prototypes',
            useCase3Desc: 'Quick models for UI and spatial mockups',
            useCase4Title: 'Multiple formats',
            useCase4Desc: 'Export to FBX, OBJ, glTF, and more',
            demoCta: 'Try demo',
            showcaseTitle: 'What you can build',
            project1Title: 'Indie game character pack',
            project1Desc: '10 3D characters from 2D concepts, rigging & animation ready',
            project1Meta: '~2 weeks · Modelia only',
            project2Title: 'Short-film VFX pack',
            project2Desc: '20 3D VFX assets for compositing',
            project2Meta: '~1 week · Modelia + edit tools',
            project3Title: 'VR exhibition prototype',
            project3Desc: 'Exhibition space & exhibits in 3D, real-time viewer',
            project3Meta: '~3 weeks · Modelia + Unity',
            demoTitle: 'Modelia Demo',
            demoInputLabel: 'Example input',
            demoOutputLabel: 'Result',
            demoExample1Label: 'Generate character',
            demoExample1Code: "modelia.generate({ type: 'character', style: 'lowpoly' })",
            demoExample1Result: 'character_lp_01.fbx (1.2MB)',
            demoExample2Label: 'Generate object',
            demoExample2Code: "modelia.generate({ type: 'object', prompt: 'medieval chest' })",
            demoExample2Result: 'object_chest_01.glb (0.8MB)',
            demoExample3Label: 'Generate environment',
            demoExample3Code: "modelia.generate({ type: 'environment', resolution: '2k' })",
            demoExample3Result: 'env_forest_01.fbx (3.1MB)',
          },
          tech: {
            javascript: 'JavaScript', typescript: 'TypeScript', react: 'React', vue: 'Vue.js', next: 'Next.js', angular: 'Angular', svelte: 'Svelte', jquery: 'jQuery', webcomponents: 'Web Components', nuxt: 'Nuxt.js', remix: 'Remix', solid: 'SolidJS',
            node: 'Node.js', django: 'Django', spring: 'Spring Boot', go: 'Go', rust: 'Rust', laravel: 'Laravel', rails: 'Ruby on Rails', dotnet: '.NET', kotlin: 'Kotlin', scala: 'Scala', nest: 'NestJS', fastapi: 'FastAPI',
            illustration: 'Illustration', pixel: 'Pixel/Dot art', landscape: 'Landscape', animation: 'Animation', logo: 'Logo & branding', character: 'Character', uiux: 'UI/UX', icon: 'Icons', texture: 'Texture', midjourney: 'AI image', dalle: 'AI image',
            planning: 'Planning', task: 'Task management', merge: 'Merge', req: 'Requirements', arch: 'Architecture', quality: 'Quality', agile: 'Agile', scrum: 'Scrum', po: 'PO', techlead: 'Tech lead',
            docker: 'Docker', cloudflare: 'Cloudflare', fly: 'Fly.io', aws: 'AWS', gcp: 'GCP', k8s: 'Kubernetes', azure: 'Azure', terraform: 'Terraform', cicd: 'CI/CD', monitor: 'Monitoring', devops: 'DevOps', data: 'Data', vercel: 'Vercel', netlify: 'Netlify',
            audit: 'Code audit', access: 'Access control', crypto: 'Encryption', vuln: 'Vulnerability scan', log: 'Log analysis', network: 'Network security', pentest: 'Penetration test', firewall: 'Firewall', ids: 'IDS/IPS', compliance: 'Compliance', zerotrust: 'Zero Trust', threat: 'Threat detection',
            excel: 'Excel', ppt: 'PowerPoint', github_doc: 'GitHub docs', word: 'Word', notion: 'Notion', mail: 'Email', confluence: 'Confluence', markdown: 'Markdown', api_doc: 'API docs', tech_writer: 'Technical writing', figma_doc: 'Figma docs', swagger: 'Swagger',
          },
          frontend: {
            heroTitle: '{{productName}}: Build modern UI with {{tech}}',
            heroSubtitle: 'From components to state and routing—accelerate frontend development.',
            useCase1Title: 'SPA & SSR',
            useCase1Desc: 'Single-page apps and server-side rendering',
            useCase2Title: 'State management',
            useCase2Desc: 'Global/local state and forms',
            useCase3Title: 'Responsive UI',
            useCase3Desc: 'Adapt to all screen sizes',
            useCase4Title: 'A11y & SEO',
            useCase4Desc: 'Semantics, meta, and performance',
            demoCta: 'View example code',
            demoExampleCode: "const App = () => {\n  const [count, setCount] = useState(0);\n  return (\n    <div>\n      <button onClick={() => setCount(c => c + 1)}>{count}</button>\n    </div>\n  );\n};",
            demoExampleResult: '✓ Component rendered\n✓ Count increments on click\n✓ React 18 compatible',
            showcaseTitle: 'What you can build',
            project1Title: 'Dashboard & admin',
            project1Desc: 'Admin UI with tables, charts, filters',
            project1Meta: '~2 weeks · {{productName}} only',
            project2Title: 'Landing & marketing',
            project2Desc: 'SEO-friendly, responsive landing pages',
            project2Meta: '~1 week · {{productName}} + backend',
            project3Title: 'E‑commerce & checkout',
            project3Desc: 'Cart, payment, order history UI',
            project3Meta: '~3 weeks · {{productName}} + API',
          },
          backend: {
            heroTitle: '{{productName}}: Build APIs and servers with {{tech}}',
            heroSubtitle: 'REST, auth, and DB—accelerate backend development.',
            useCase1Title: 'REST API',
            useCase1Desc: 'Endpoints, validation, error handling',
            useCase2Title: 'DB & ORM',
            useCase2Desc: 'Models, migrations, queries',
            useCase3Title: 'Auth & permissions',
            useCase3Desc: 'JWT, session, role-based access',
            useCase4Title: 'Realtime & batch',
            useCase4Desc: 'WebSocket, queues, schedules',
            demoCta: 'View example code',
            demoExampleCode: "app.get('/api/users', (req, res) => {\n  const users = await db.query('SELECT * FROM users');\n  res.json(users);\n});",
            demoExampleResult: '✓ GET /api/users 200\n✓ [{ "id": 1, "name": "..." }]',
            showcaseTitle: 'What you can build',
            project1Title: 'Auth & payment API',
            project1Desc: 'Signup, login, payment API',
            project1Meta: '~2 weeks · {{productName}} only',
            project2Title: 'Admin back office',
            project2Desc: 'CRUD, dashboard, report API',
            project2Meta: '~3 weeks · {{productName}} + frontend',
            project3Title: 'Microservices',
            project3Desc: 'Service split, events, messaging',
            project3Meta: '~4 weeks · {{productName}} + infra',
          },
          image: {
            heroTitle: '{{productName}}: Generates {{tech}}',
            heroSubtitle: 'High-quality output tailored to prompt and style.',
            useCase1Title: 'Style & quality',
            useCase1Desc: 'Multiple styles and resolutions',
            useCase2Title: 'Batch output',
            useCase2Desc: 'Multiple assets, consistent tone',
            useCase3Title: 'Edit & retouch',
            useCase3Desc: 'Revisions and refinements',
            useCase4Title: 'Format & export',
            useCase4Desc: 'Various formats and download',
            demoCta: 'View example output',
            demoExamplePrompt: 'prompt: "illustration, landscape, logo..."\nstyle: "minimal"',
            demoImageLabel: 'Generated result',
            showcaseTitle: 'What you can build',
            project1Title: 'App & web assets',
            project1Desc: 'UI images, icons, illustrations',
            project1Meta: '~1 week · {{productName}}',
            project2Title: 'Marketing & ads',
            project2Desc: 'Banners, social, presentation',
            project2Meta: '~1 week · {{productName}}',
            project3Title: 'Game & video',
            project3Desc: 'Characters, backgrounds, VFX',
            project3Meta: '~2 weeks · {{productName}} + tools',
          },
          management: {
            heroTitle: '{{productName}}: Lead projects with {{tech}}',
            heroSubtitle: 'Planning, schedule, quality—boost team productivity.',
            useCase1Title: 'Schedule & tasks',
            useCase1Desc: 'WBS, milestones, assignments',
            useCase2Title: 'Docs & specs',
            useCase2Desc: 'Requirements, specs, meeting notes',
            useCase3Title: 'Quality & review',
            useCase3Desc: 'Code review, testing, release',
            useCase4Title: 'Collaboration',
            useCase4Desc: 'Notifications, issues, retro',
            demoCta: 'View example',
            demoExampleCode: "- [ ] Task A\n- [ ] Task B\nMilestone: 2025-02-15",
            demoExampleResult: '✓ WBS generated\n✓ Assignee suggestions\n✓ Schedule chart updated',
            showcaseTitle: 'What you can build',
            project1Title: 'Sprint operation',
            project1Desc: 'Sprint planning, standups, retro',
            project1Meta: 'Ongoing · {{productName}}',
            project2Title: 'Requirements & specs',
            project2Desc: 'PRD, feature spec, API spec',
            project2Meta: '~2 weeks · {{productName}}',
            project3Title: 'Architecture & refactor',
            project3Desc: 'System design, tech choices, improvement',
            project3Meta: '~3 weeks · {{productName}}',
          },
          infrastructure: {
            heroTitle: '{{productName}}: Build infrastructure with {{tech}}',
            heroSubtitle: 'Deploy, monitor, automate—run stable services.',
            useCase1Title: 'Build & deploy',
            useCase1Desc: 'CI/CD, containers, staging',
            useCase2Title: 'Resources & network',
            useCase2Desc: 'Servers, storage, CDN',
            useCase3Title: 'Monitoring & alerts',
            useCase3Desc: 'Logs, metrics, incident response',
            useCase4Title: 'Security & cost',
            useCase4Desc: 'Access control, cost optimization',
            demoCta: 'View example config',
            demoExampleCode: "docker run -d -p 8080:80 \\\n  --name app my-registry/app:latest",
            demoExampleResult: '✓ Container started\n✓ 8080 → 80 mapped\n✓ Health check passed',
            showcaseTitle: 'What you can build',
            project1Title: 'Container deployment',
            project1Desc: 'Docker, K8s, health checks',
            project1Meta: '~1 week · {{productName}}',
            project2Title: 'Multi-region service',
            project2Desc: 'Global CDN, DB, backup',
            project2Meta: '~2 weeks · {{productName}}',
            project3Title: 'IaC & automation',
            project3Desc: 'Terraform, pipelines, events',
            project3Meta: '~3 weeks · {{productName}}',
          },
          security: {
            heroTitle: '{{productName}}: Strengthen security with {{tech}}',
            heroSubtitle: 'Audit, encryption, intrusion detection—keep systems safe.',
            useCase1Title: 'Policy & access',
            useCase1Desc: 'Permissions, auth, session',
            useCase2Title: 'Encryption & keys',
            useCase2Desc: 'Data and communication encryption',
            useCase3Title: 'Scan & response',
            useCase3Desc: 'Vulnerabilities, IDS, response',
            useCase4Title: 'Compliance',
            useCase4Desc: 'Policy, audit, reports',
            demoCta: 'View example',
            demoExampleCode: "audit.run({ target: 'src/', rules: 'owasp' })",
            demoExampleResult: '✓ 12 files scanned\n✓ 0 vulnerabilities, 2 warnings\n✓ Report generated',
            showcaseTitle: 'What you can build',
            project1Title: 'Security audit & report',
            project1Desc: 'Code and config audit, recommendations',
            project1Meta: '~1 week · {{productName}}',
            project2Title: 'Auth & permissions',
            project2Desc: 'SSO, RBAC, event logs',
            project2Meta: '~2 weeks · {{productName}}',
            project3Title: 'Threat response pipeline',
            project3Desc: 'Detection, classification, response, report',
            project3Meta: '~3 weeks · {{productName}}',
          },
          documents: {
            heroTitle: '{{productName}}: Helps with {{tech}} documentation',
            heroSubtitle: 'Draft, organize, automate—speed up document work.',
            useCase1Title: 'Draft & summary',
            useCase1Desc: 'Auto-write, translate, summarize',
            useCase2Title: 'Templates & format',
            useCase2Desc: 'Reports, specs, slides',
            useCase3Title: 'Collaboration & version',
            useCase3Desc: 'Share, review, version control',
            useCase4Title: 'Search & integration',
            useCase4Desc: 'Search, API, tool integration',
            demoCta: 'View example',
            demoExampleCode: "doc.generate({ type: 'readme', repo: 'my-app' })",
            demoExampleResult: '✓ README.md generated\n✓ Install, usage, API summary\n✓ Changelog included',
            showcaseTitle: 'What you can build',
            project1Title: 'Technical & API docs',
            project1Desc: 'README, spec, changelog',
            project1Meta: '~1 week · {{productName}}',
            project2Title: 'Reports & proposals',
            project2Desc: 'Weekly reports, proposals, meeting notes',
            project2Meta: '~1 week · {{productName}}',
            project3Title: 'Knowledge base',
            project3Desc: 'Confluence, Notion, FAQ',
            project3Meta: '~2 weeks · {{productName}}',
          },
        },
        demos: showcaseDemosEn,
        trust: {
  ...
  ja: {
    translation: {
      ...
      chatbot: {
        ...
        closeAria: '閉じる',
        greeting: 'こんにちは 👋',
        greetingSub: '何かお困りですか？',
        help: 'ヘルプ',
        recentMessages: '最近のメッセージ',
        startConversation: '会話を始める',
        agentMeta: 'AIDE Marketアシスタント • 現在',
        statusOk: '全システム正常稼働中',
        statusMeta: 'AIDE Marketアシスタント準備完了',
        searchPlaceholder: '検索...',
        helpSearchTitle: 'ヘルプ検索',
        searchDefaultQuery: 'ヘルプを表示',
        helpIntro: 'ご利用前にご確認ください！',
        getSupport: 'サポートを受ける方法',
        aideIntro: 'AIDE Marketとは',
        ...
        home: 'ホーム',
        messages: 'メッセージ',
        queryGetSupport: 'サポートを受ける方法',
        queryAideIntro: 'AIDE Marketとは？',
        queryStudentDiscount: '学生割引を教えて',
        queryFaq: 'よくある質問を教えて',
      },
      notifications: {
        team: {
        ...
        share: {
          ...
          shareMessage: '{{name}}をチェックしてみてください！',
          shareTooltip: '共有',
        },
        subscription: {
...
実際のサービスリリースまで時間を大幅に短縮できました。" - プロジェクトリーダー`,
      ...
      creators: {
        ...
        noProductsHint: '新しいAI商品を近日お届けします。',
        downloads: 'ダウンロード',
        totalDownloads: '総ダウンロード',
        avgRating: '平均評価',
        totalReviews: '総レビュー',
        categoryDistribution: 'カテゴリ別商品分布',
        productsCount: '商品数',
        followers: 'フォロワー',
        followError: 'フォロー処理中にエラーが発生しました。',
        followHint: 'フォローで新AIリリース・イベント情報をお届け',
        followHintDetail: 'フォローすると新AIリリースや特別イベントをいち早く受け取れます',
        whyFollowTitle: 'フォローするメリット',
        whyFollow1: '新AIリリース時に通知を受け取れます',
        whyFollow2: '特別割引・イベント情報をお届け',
        whyFollow3: 'マイページで気になるクリエイターを一覧表示',
        whyFollow4: '人気開発者の最新AIを見逃さない',
      },
      sellerInfo: {
        pageTitle: '販売者案内',
      ...
      profile: {
        ...
        reviews: {
          ...
          ratingLabel: '評価',
          reviewTitleLabel: 'レビュータイトル',
          reviewTitlePlaceholder: 'タイトルを入力...',
          ...
          reviewImagesLabel: 'レビュー画像',
          addImage: '画像を追加',
          removeImage: '削除',
          imageOnly: '画像ファイルのみアップロード可能です。',
          imageSize: '画像サイズは5MB以下にしてください。',
          reviewImagesHint: '最大{{max}}枚まで。クリックで削除できます。',
          edit: '編集',
          delete: '削除',
        ...
        superAdmin: {
          ...
          products: {
            ...
            mock: {
              ...
              categoryDesign: 'デザイン',
              product1: {
                name: 'AIコードレビュアー - 自動品質検査',
                description: 'コード品質を自動で検査し、改善点を提案するAIツールです。複数言語をサポートしています。',
              },
              product2: {
                name: '自動レポート作成AI',
                description: 'テーマを入力するだけで自動でレポートを作成するAIサービスです。',
              },
              product3: {
                name: '画像背景除去AI',
                description: '画像から背景を自動で除去し、透明PNGで保存します。',
              },
            },
          },
          studentVerifications: {
      ...
      useCaseGuide: {
        title: '何を作りたいですか？',
        subtitle: '目的に合ったテンプレートを選んで始めましょう',
        web: { label: 'ウェブサイト', desc: '会社サイト、ブログなど' },
        shop: { label: 'ショッピングモール', desc: 'オンラインストア運営' },
        app: { label: 'アプリ', desc: 'モバイル・Androidアプリ' },
        doc: { label: '文書・業務自動化', desc: 'レポート、要約、整理など' },
        custom: { label: '自分で構成', desc: 'お気に入りから選んでチーム作成' },
      },
      teamBuilder: {
        pageTitle: 'AIチーム構成',
        pageSubtitle: '目的に合わせてAIを組み合わせ、最強のチームを作りましょう',
        typing1: 'ビジネス分析から始めてみませんか？',
        typing2: 'ウェブ開発チームを構成しましょう',
        typing3: 'カスタムAIチームを作成しましょう',
        ...
        recommendedProjectsTitle: 'おすすめプロジェクト',
      ...
      product: {
        ...
        showcase: {
          empty: '登録されたプロジェクトがありません。',
          useCasesHeading: 'こんな使い方ができます',
          demoPlaceholder: '3Dモデル生成デモは準備中です。近日お試しいただけます。',
          demoHint: '例を選ぶと入力・結果が切り替わります。',
          demoInputLabel: '入力例',
          demoOutputLabel: '結果',
          demoImagePlaceholder: 'configのdemoImageUrlを設定するとデモ画像を表示します',
          modelia: {
            heroTitle: '高品質3Dモデルを生成します',
            heroSubtitle: 'ゲーム・映像制作にそのまま使える3Dアセットを作成。',
            useCase1Title: 'ゲームアセット',
            useCase1Desc: 'キャラ・オブジェクト・環境の3Dモデル',
            useCase2Title: '映像・VFX',
            useCase2Desc: '映像用3Dソースと演出用アセット',
            useCase3Title: 'プロトタイプ',
            useCase3Desc: 'UI・空間ビジュアル用の迅速なモデル',
            useCase4Title: '多彩なフォーマット',
            useCase4Desc: 'FBX、OBJ、glTFなどで書き出し',
            demoCta: 'デモを体験する',
            showcaseTitle: 'こんな制作例',
            project1Title: 'インディゲーム用キャラクターパック',
            project1Desc: '2Dコンセプトから3Dキャラ10種を生成、リグ・アニメ対応',
            project1Meta: '約2週間・Modelia単体',
            project2Title: 'ショート映像VFXソース',
            project2Desc: '爆発・環境3Dソース20種、コンポジット用',
            project2Meta: '約1週間・Modelia＋編集ツール',
            project3Title: 'VR展示会プロトタイプ',
            project3Desc: '展示空間・展示物の3Dモデル、リアルタイムビューア連携',
            project3Meta: '約3週間・Modelia＋Unity',
            demoTitle: 'Modelia デモ',
            demoInputLabel: '入力例',
            demoOutputLabel: '結果',
            demoExample1Label: 'キャラクター生成',
            demoExample1Code: "modelia.generate({ type: 'character', style: 'lowpoly' })",
            demoExample1Result: 'character_lp_01.fbx (1.2MB)',
            demoExample2Label: 'オブジェクト生成',
            demoExample2Code: "modelia.generate({ type: 'object', prompt: 'medieval chest' })",
            demoExample2Result: 'object_chest_01.glb (0.8MB)',
            demoExample3Label: '環境生成',
            demoExample3Code: "modelia.generate({ type: 'environment', resolution: '2k' })",
            demoExample3Result: 'env_forest_01.fbx (3.1MB)',
          },
          tech: {
            javascript: 'JavaScript', typescript: 'TypeScript', react: 'React', vue: 'Vue.js', next: 'Next.js', angular: 'Angular', svelte: 'Svelte', jquery: 'jQuery', webcomponents: 'Web Components', nuxt: 'Nuxt.js', remix: 'Remix', solid: 'SolidJS',
            node: 'Node.js', django: 'Django', spring: 'Spring Boot', go: 'Go', rust: 'Rust', laravel: 'Laravel', rails: 'Ruby on Rails', dotnet: '.NET', kotlin: 'Kotlin', scala: 'Scala', nest: 'NestJS', fastapi: 'FastAPI',
            illustration: 'イラスト', pixel: 'ドット・ピクセル', landscape: '風景', animation: 'アニメーション', logo: 'ロゴ・ブランディング', character: 'キャラクター', uiux: 'UI/UX', icon: 'アイコン', texture: 'テクスチャ', midjourney: 'AI画像', dalle: 'AI画像',
            planning: '企画', task: 'タスク管理', merge: '統合', req: '要件定義', arch: 'アーキテクチャ', quality: '品質', agile: 'アジャイル', scrum: 'スクラム', po: 'PO', techlead: 'テックリード',
            docker: 'Docker', cloudflare: 'Cloudflare', fly: 'Fly.io', aws: 'AWS', gcp: 'GCP', k8s: 'Kubernetes', azure: 'Azure', terraform: 'Terraform', cicd: 'CI/CD', monitor: 'モニタリング', devops: 'DevOps', data: 'データ', vercel: 'Vercel', netlify: 'Netlify',
            audit: 'コード監査', access: 'アクセス制御', crypto: '暗号化', vuln: '脆弱性スキャン', log: 'ログ分析', network: 'ネットワークセキュリティ', pentest: 'ペネトレーションテスト', firewall: 'ファイアウォール', ids: 'IDS/IPS', compliance: 'コンプライアンス', zerotrust: 'ゼロトラスト', threat: '脅威検知',
            excel: 'Excel', ppt: 'PowerPoint', github_doc: 'GitHubドキュメント', word: 'Word', notion: 'Notion', mail: 'メール', confluence: 'Confluence', markdown: 'Markdown', api_doc: 'APIドキュメント', tech_writer: '技術文書', figma_doc: 'Figmaドキュメント', swagger: 'Swagger',
          },
          frontend: {
            heroTitle: '{{productName}}: {{tech}}でモダンなUIを構築',
            heroSubtitle: 'コンポーネント・状態管理・ルーティングまで、フロントエンド開発を加速。',
            useCase1Title: 'SPA・SSR',
            useCase1Desc: 'シングルページアプリ・サーバーサイドレンダリング',
            useCase2Title: '状態管理',
            useCase2Desc: 'グローバル/ローカル状態・フォーム',
            useCase3Title: 'レスポンシブUI',
            useCase3Desc: '多様な画面サイズに対応',
            useCase4Title: 'アクセシビリティ・SEO',
            useCase4Desc: 'セマンティクス・メタ・パフォーマンス',
            demoCta: '例コードを見る',
            demoExampleCode: "const App = () => {\n  const [count, setCount] = useState(0);\n  return (\n    <div>\n      <button onClick={() => setCount(c => c + 1)}>{count}</button>\n    </div>\n  );\n};",
            demoExampleResult: '✓ コンポーネント描画完了\n✓ クリックでcount増加\n✓ React 18対応',
            showcaseTitle: 'こんな制作例',
            project1Title: 'ダッシュボード・管理画面',
            project1Desc: 'テーブル・チャート・フィルター付き管理UI',
            project1Meta: '約2週間・{{productName}}単体',
            project2Title: 'ランディング・マーケティング',
            project2Desc: 'SEO・レスポンシブなランディング',
            project2Meta: '約1週間・{{productName}}＋バックエンド',
            project3Title: 'EC・決済フロー',
            project3Desc: 'カート・決済・注文履歴UI',
            project3Meta: '約3週間・{{productName}}＋API',
          },
          backend: {
            heroTitle: '{{productName}}: {{tech}}でAPI・サーバーを構築',
            heroSubtitle: 'REST・認証・DB連携まで、バックエンド開発を加速。',
            useCase1Title: 'REST API',
            useCase1Desc: 'エンドポイント・バリデーション・エラー処理',
            useCase2Title: 'DB・ORM',
            useCase2Desc: 'モデル・マイグレーション・クエリ',
            useCase3Title: '認証・権限',
            useCase3Desc: 'JWT・セッション・ロールベース',
            useCase4Title: 'リアルタイム・バッチ',
            useCase4Desc: 'WebSocket・キュー・スケジュール',
            demoCta: '例コードを見る',
            demoExampleCode: "app.get('/api/users', (req, res) => {\n  const users = await db.query('SELECT * FROM users');\n  res.json(users);\n});",
            demoExampleResult: '✓ GET /api/users 200\n✓ [{ "id": 1, "name": "..." }]',
            showcaseTitle: 'こんな制作例',
            project1Title: '会員・決済API',
            project1Desc: '登録・ログイン・決済連携API',
            project1Meta: '約2週間・{{productName}}単体',
            project2Title: '管理バックオフィス',
            project2Desc: 'CRUD・ダッシュボード・レポートAPI',
            project2Meta: '約3週間・{{productName}}＋フロント',
            project3Title: 'マイクロサービス',
            project3Desc: 'サービス分割・イベント・メッセージング',
            project3Meta: '約4週間・{{productName}}＋インフラ',
          },
          image: {
            heroTitle: '{{productName}}: {{tech}}を生成',
            heroSubtitle: 'プロンプト・スタイルに合わせた高品質な成果物を提供。',
            useCase1Title: 'スタイル・品質',
            useCase1Desc: '多様なスタイル・解像度',
            useCase2Title: '一括・バッチ',
            useCase2Desc: '複数枚生成・一貫したトーン',
            useCase3Title: '修正・リタッチ',
            useCase3Desc: '要望に応じた修正・補正',
            useCase4Title: 'フォーマット・連携',
            useCase4Desc: '多様なフォーマット・ダウンロード',
            demoCta: '例結果を見る',
            demoExamplePrompt: 'prompt: "イラスト、風景、ロゴなど"\nstyle: "minimal"',
            demoImageLabel: '生成結果',
            showcaseTitle: 'こんな制作例',
            project1Title: 'アプリ・Webアセット',
            project1Desc: 'UI用画像・アイコン・イラスト',
            project1Meta: '約1週間・{{productName}}',
            project2Title: 'マーケティング・広告',
            project2Desc: 'バナー・SNS・プレゼン用',
            project2Meta: '約1週間・{{productName}}',
            project3Title: 'ゲーム・映像',
            project3Desc: 'キャラ・背景・VFXソース',
            project3Meta: '約2週間・{{productName}}＋ツール',
          },
          management: {
            heroTitle: '{{productName}}: {{tech}}でプロジェクトをリード',
            heroSubtitle: '企画・スケジュール・品質まで、チーム生産性を向上。',
            useCase1Title: 'スケジュール・タスク',
            useCase1Desc: 'WBS・マイルストーン・担当割り当て',
            useCase2Title: 'ドキュメント・定義',
            useCase2Desc: '要件・スペック・議事録',
            useCase3Title: '品質・レビュー',
            useCase3Desc: 'コードレビュー・テスト・リリース',
            useCase4Title: '協働・コミュニケーション',
            useCase4Desc: '通知・イシュー・振り返り',
            demoCta: '例を見る',
            demoExampleCode: "- [ ] タスクA\n- [ ] タスクB\nマイルストーン: 2025-02-15",
            demoExampleResult: '✓ WBS作成完了\n✓ 担当者アサイン提案\n✓ スケジュールチャート反映',
            showcaseTitle: 'こんな制作例',
            project1Title: 'スプリント運用',
            project1Desc: 'スプリント計画・デイリースタンドアップ・振り返り',
            project1Meta: '継続・{{productName}}',
            project2Title: '要件・スペック整理',
            project2Desc: 'PRD・機能仕様・APIスペック',
            project2Meta: '約2週間・{{productName}}',
            project3Title: 'アーキテクチャ・リファクタ',
            project3Desc: 'システム設計・技術選定・改善',
            project3Meta: '約3週間・{{productName}}',
          },
          infrastructure: {
            heroTitle: '{{productName}}: {{tech}}でインフラを構築',
            heroSubtitle: 'デプロイ・モニタリング・自動化で安定したサービスを。',
            useCase1Title: 'ビルド・デプロイ',
            useCase1Desc: 'CI/CD・コンテナ・ステージング',
            useCase2Title: 'リソース・ネットワーク',
            useCase2Desc: 'サーバー・ストレージ・CDN',
            useCase3Title: 'モニタリング・アラート',
            useCase3Desc: 'ログ・メトリクス・障害対応',
            useCase4Title: 'セキュリティ・コスト',
            useCase4Desc: 'アクセス制御・コスト最適化',
            demoCta: '例設定を見る',
            demoExampleCode: "docker run -d -p 8080:80 \\\n  --name app my-registry/app:latest",
            demoExampleResult: '✓ コンテナ起動\n✓ 8080→80マッピング\n✓ ヘルスチェック合格',
            showcaseTitle: 'こんな制作例',
            project1Title: 'コンテナデプロイ',
            project1Desc: 'Docker・K8s・ヘルスチェック',
            project1Meta: '約1週間・{{productName}}',
            project2Title: 'マルチリージョンサービス',
            project2Desc: 'グローバルCDN・DB・バックアップ',
            project2Meta: '約2週間・{{productName}}',
            project3Title: 'IaC・自動化',
            project3Desc: 'Terraform・パイプライン・イベント',
            project3Meta: '約3週間・{{productName}}',
          },
          security: {
            heroTitle: '{{productName}}: {{tech}}でセキュリティを強化',
            heroSubtitle: '監査・暗号化・侵入検知で安全なシステムを。',
            useCase1Title: 'ポリシー・アクセス制御',
            useCase1Desc: '権限・認証・セッション',
            useCase2Title: '暗号化・キー管理',
            useCase2Desc: 'データ・通信の暗号化',
            useCase3Title: 'スキャン・対応',
            useCase3Desc: '脆弱性・侵入検知・対応',
            useCase4Title: 'コンプライアンス',
            useCase4Desc: 'ポリシー・監査・レポート',
            demoCta: '例を見る',
            demoExampleCode: "audit.run({ target: 'src/', rules: 'owasp' })",
            demoExampleResult: '✓ 12ファイルスキャン\n✓ 脆弱性0、警告2\n✓ レポート生成完了',
            showcaseTitle: 'こんな制作例',
            project1Title: 'セキュリティ監査・レポート',
            project1Desc: 'コード・設定監査・推奨事項',
            project1Meta: '約1週間・{{productName}}',
            project2Title: '認証・権限体制',
            project2Desc: 'SSO・RBAC・イベントログ',
            project2Meta: '約2週間・{{productName}}',
            project3Title: '脅威対応パイプライン',
            project3Desc: '検知・分類・対応・レポート',
            project3Meta: '約3週間・{{productName}}',
          },
          documents: {
            heroTitle: '{{productName}}: {{tech}}のドキュメント作業を支援',
            heroSubtitle: '作成・整理・自動化でドキュメント業務を加速。',
            useCase1Title: '下書き・要約',
            useCase1Desc: '自動作成・翻訳・要約',
            useCase2Title: 'テンプレート・形式',
            useCase2Desc: '報告書・スペック・スライド',
            useCase3Title: '協働・バージョン',
            useCase3Desc: '共有・レビュー・バージョン管理',
            useCase4Title: '検索・連携',
            useCase4Desc: '検索・API・他ツール連携',
            demoCta: '例を見る',
            demoExampleCode: "doc.generate({ type: 'readme', repo: 'my-app' })",
            demoExampleResult: '✓ README.md生成\n✓ インストール・使い方・API概要\n✓ Changelog反映',
            showcaseTitle: 'こんな制作例',
            project1Title: '技術・APIドキュメント',
            project1Desc: 'README・スペック・Changelog',
            project1Meta: '約1週間・{{productName}}',
            project2Title: '報告書・提案書',
            project2Desc: '週次報告・提案書・議事録',
            project2Meta: '約1週間・{{productName}}',
            project3Title: 'ナレッジベース',
            project3Desc: 'Confluence・Notion・FAQ',
            project3Meta: '約2週間・{{productName}}',
          },
        },
        demos: showcaseDemosJa,
        trust: {
          title: '検証と信頼',
          identity: '本人確認完了',
          topRated: '最高評価開発者',
